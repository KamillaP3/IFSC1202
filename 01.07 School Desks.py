numberofstudentsA = input("Enter Number of Hours in Classroom A: ")
numberofstudentsB = input("Enter Number of Hours in Classroom B: ")
numberofstudentsC = input("Enter Number of Hours in Classroom C: ")
